...
class NestedBenchmark : AbstractBenchmark(StartupMode.COLD){

    @Test
    fun measureNestedScreenComposable() = benchmark(CompilationMode.Partial())

    override val metrics: List<Metric> = listOf(
        FrameTimingGfxInfoMetric(),
        TraceSectionMetric(NESTED_ITEM, Mode.Sum),
    )
